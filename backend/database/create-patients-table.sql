-- Create improved patients table with created_by column
...
CREATE TABLE patients (
    ...
    created_by INTEGER NOT NULL, -- Employee ID who created the record
    ...
    CONSTRAINT chk_pin_code CHECK (LENGTH(pin_code) = 6)
);
...
COMMENT ON TABLE patients IS 'Patient registration and management table';
